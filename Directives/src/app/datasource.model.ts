...
export class SimpleDataSource{
    private products: Product[]; //dışardan bir yapı çağrıldı
    constructor(){ //dışardan gelen product dizisine değer atama
    ...
    //private olan üyeyi public olarak dışarıya açacak metot
    getProducts(): Product[]{
